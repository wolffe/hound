...
if($temppass == $password) {
    ...
    <div class="content">
        <div class="content main">
            ...
            <form role="form" name="form1" id="form1" action="new-post.php" method="post">
                ...
                <p>
                    ...
                    <br><small>A unique post identification string</small>
                </p>

                <p>
                    <b>Content</b><br>
                    <textarea id="txtTextArea1" name="content" style="width:100%" rows="10"></textarea>
                    <br><small>Content of post</small>
                </p>
                ...
                <p>
                    <button type="submit" class="thin-ui-button thin-ui-button-primary">Create post</button>
                </p>
            </form>
        </div>
    </div>
