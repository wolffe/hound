    ...
    <div class="content">
        <div class="content main">
            ...
            if($_POST['op'] == 'mod' && $_POST['title'] != 'admin') {
                ...
                rename("../site/pages/post-$page.txt","../site/pages/post-$slug.txt");
                $page=$slug;

          }
            $paramofpage=$houndAdmin->read_param("../site/pages/post-$page.txt");
          ...
          ?>
            ...
            <h2>Edit post</h2>
            <div>
                <a class="thin-ui-button thin-ui-button-primary" target="_blank" href="../<?php echo $page; ?>/">Post preview </a>
            </div>    

            <br>

            <form role="form" id="commentForm" action="edit-post.php?page=<?php echo $page;?>" method="post">
                ...
                <?php if($paramofpage['slug'] != 'index') { ?>
                    <p>
                        ...
                        <br><small>A unique post identification separated by "-" (minus)</small>
                    </p>
                <?php } else { ?>
                ...
                <p>
                    <b>Template</b>
                    <br><small>Template of post</small>
